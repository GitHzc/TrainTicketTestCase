...
public enum MsMappingEnum {
    ...
    MsMappingEnum(String api, String serviceName) {
        this.api = api;
    ...
    public static String getServiceNameByApi(String api) {
        for(MsMappingEnum mappingEnum : MsMappingEnum.values()) {
            if (mappingEnum.api.equals(api)) {
                return mappingEnum.serviceName;
            }
        }
        return "";
    }
